...
if __name__ == '__main__':
    ...
    original_gfp_strand_sticky, complementary_gfp_strand_sticky = cut_gfp(
        original_gfp_strand.rstrip("\n"),
        gfp_restriction_sites.rstrip("\n"))
    glowing_bacteria(plasmid_cut.split()[0], original_gfp_strand_sticky, plasmid_cut.split()[1],
                     complement_cut.split()[0], complementary_gfp_strand_sticky,
                     complement_cut.split()[1])
